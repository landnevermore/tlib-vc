...
derma.DefineControl( "TLib.TextEntry", "A simple TextEntry control", PANEL, "TextEntry" )

--[[---------------------------------------------------------
	Clear the focus when we click away from us..
-----------------------------------------------------------]]
function TLib.TextEntryLoseFocus( panel, mcode )
...
hook.Add( "VGUIMousePressed", "TLib.TextEntryLoseFocus", TLib.TextEntryLoseFocus )