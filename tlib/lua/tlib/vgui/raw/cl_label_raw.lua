...
function PANEL:Init()
	...
	self:SetText("This is a Label where the Text is not Set, contact the Owner if you think this is a Bug")
...
vgui.Register( "TLib.Label_internal", PANEL, "Label" )

-- Convenience Function
function Label( strText, parent )

	local lbl = vgui.Create( "TLib.Label_internal", parent )
	lbl:SetText( strText )
