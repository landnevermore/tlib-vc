...
function PANEL:Init()
	...
	self:SetText( "" )
	self:SetFont( "TLib.Font.Tooltip" )
...
function PANEL:Paint( w, h )
	...
	TLib.DrawRoundedOutline(0,0,w,h, TLib.Theme.accent, TLib.Theme.accentalpha)
end
...
vgui.Register("TLib.Tooltip", PANEL, "TLib.Label_internal")