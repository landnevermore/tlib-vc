...
function PANEL:Init()
	...
	self.Label = vgui.Create( "TLib.Tree_Node_Button", self )
...
function PANEL:AddNode( strName, strIcon )
	...
	local pNode = vgui.Create( "TLib.Tree_Node", self )
...
function PANEL:Copy()
	...
	local copy = vgui.Create( "TLib.Tree_Node", self:GetParent() )
...
derma.DefineControl( "TLib.Tree_Node", "Tree Node", PANEL, "TLib.Panel" )
