...
function PANEL:AddColumn( strName, iPosition )
	...
	if ( self.m_bSortable ) then
		pColumn = vgui.Create( "TLib.Column", self )
	else
		pColumn = vgui.Create( "TLib.ColumnPlain", self )
	end
...
function PANEL:AddLine( ... )
	...
	local Line = vgui.Create( "TLib.ListView_Line", self.pnlCanvas )
...
-- derma.DefineControl( "TLib.ListView", "Data View", PANEL, "DPanel" )
vgui.Register( "TLib.ListView", PANEL, "TLib.Panel" )